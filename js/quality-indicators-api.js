...
const INDICATORS = {
    ...
    // ========== 西醫基層指標 (Official ELM 3.10.0) ==========
    'indicator-pc-1':    { cql: 'Indicator_PC_01_Outpatient_Injection_Usage_Rate',                title: '門診注射劑使用率',                       code: '基-1',    metric: '使用率', category: 'medication', rateId: 'indPc1Rate',    suffix: '_pc_1'    },
    'indicator-pc-2-1':  { cql: 'Indicator_PC_02_1_Outpatient_Antibiotic_Usage_Rate',             title: '門診抗生素藥品使用率',                code: '基-2-1',  metric: '使用率', category: 'medication', rateId: 'indPc2_1Rate',  suffix: '_pc_2_1'  },
    'indicator-pc-2-2':  { cql: 'Indicator_PC_02_2_Outpatient_Quinolone_Aminoglycoside_Usage_Rate', title: '門診Quinolone/Aminoglycoside抗生素使用率', code: '基-2-2', metric: '使用率', category: 'medication', rateId: 'indPc2_2Rate', suffix: '_pc_2_2' },
    'indicator-pc-3-1':  { cql: 'Indicator_PC_03_1_Same_Hospital_Antihypertensive_Overlap',       title: '同院降血壓藥重疊率',                    code: '基-3-1',  metric: '重疊率', category: 'medication', rateId: 'indPc3_1Rate',  suffix: '_pc_3_1'  },
    'indicator-pc-3-2':  { cql: 'Indicator_PC_03_2_Same_Hospital_Lipid_Lowering_Overlap',         title: '同院降血脂藥重疊率',                    code: '基-3-2',  metric: '重疊率', category: 'medication', rateId: 'indPc3_2Rate',  suffix: '_pc_3_2'  },
    'indicator-pc-3-3':  { cql: 'Indicator_PC_03_3_Same_Hospital_Antidiabetic_Overlap',           title: '同院降血糖藥重疊率',                    code: '基-3-3',  metric: '重疊率', category: 'medication', rateId: 'indPc3_3Rate',  suffix: '_pc_3_3'  },
    'indicator-pc-3-4':  { cql: 'Indicator_PC_03_4_Same_Hospital_Antipsychotic_Overlap',          title: '同院抗思覺失調藥重疊率',           code: '基-3-4',  metric: '重疊率', category: 'medication', rateId: 'indPc3_4Rate',  suffix: '_pc_3_4'  },
    'indicator-pc-3-5':  { cql: 'Indicator_PC_03_5_Same_Hospital_Antidepressant_Overlap',         title: '同院抗憂鬱藥重疊率',                    code: '基-3-5',  metric: '重疊率', category: 'medication', rateId: 'indPc3_5Rate',  suffix: '_pc_3_5'  },
    'indicator-pc-3-6':  { cql: 'Indicator_PC_03_6_Same_Hospital_Sedative_Overlap',               title: '同院安眠鎮靜藥重疊率',                code: '基-3-6',  metric: '重疊率', category: 'medication', rateId: 'indPc3_6Rate',  suffix: '_pc_3_6'  },
    'indicator-pc-3-7':  { cql: 'Indicator_PC_03_7_Same_Hospital_Antithrombotic_Overlap',         title: '同院抗血栖藥重疊率',                    code: '基-3-7',  metric: '重疊率', category: 'medication', rateId: 'indPc3_7Rate',  suffix: '_pc_3_7'  },
    'indicator-pc-3-8':  { cql: 'Indicator_PC_03_8_Same_Hospital_Prostate_Overlap',               title: '同院前列腰藥重疊率',                    code: '基-3-8',  metric: '重疊率', category: 'medication', rateId: 'indPc3_8Rate',  suffix: '_pc_3_8'  },
    'indicator-pc-3-9':  { cql: 'Indicator_PC_03_9_Cross_Hospital_Antihypertensive_Overlap',      title: '跨院降血壓藥重疊率',                    code: '基-3-9',  metric: '重疊率', category: 'medication', rateId: 'indPc3_9Rate',  suffix: '_pc_3_9'  },
    'indicator-pc-3-10': { cql: 'Indicator_PC_03_10_Cross_Hospital_Lipid_Lowering_Overlap',       title: '跨院降血脂藥重疊率',                    code: '基-3-10', metric: '重疊率', category: 'medication', rateId: 'indPc3_10Rate', suffix: '_pc_3_10' },
    'indicator-pc-3-11': { cql: 'Indicator_PC_03_11_Cross_Hospital_Antidiabetic_Overlap',         title: '跨院降血糖藥重疊率',                    code: '基-3-11', metric: '重疊率', category: 'medication', rateId: 'indPc3_11Rate', suffix: '_pc_3_11' },
    'indicator-pc-3-12': { cql: 'Indicator_PC_03_12_Cross_Hospital_Antipsychotic_Overlap',        title: '跨院抗思覺失調藥重疊率',           code: '基-3-12', metric: '重疊率', category: 'medication', rateId: 'indPc3_12Rate', suffix: '_pc_3_12' },
    'indicator-pc-3-13': { cql: 'Indicator_PC_03_13_Cross_Hospital_Antidepressant_Overlap',       title: '跨院抗憂鬱藥重疊率',                    code: '基-3-13', metric: '重疊率', category: 'medication', rateId: 'indPc3_13Rate', suffix: '_pc_3_13' },
    'indicator-pc-3-14': { cql: 'Indicator_PC_03_14_Cross_Hospital_Sedative_Overlap',             title: '跨院安眠鎮靜藥重疊率',                code: '基-3-14', metric: '重疊率', category: 'medication', rateId: 'indPc3_14Rate', suffix: '_pc_3_14' },
    'indicator-pc-3-15': { cql: 'Indicator_PC_03_15_Cross_Hospital_Antithrombotic_Overlap',       title: '跨院抗血栖藥重疊率',                    code: '基-3-15', metric: '重疊率', category: 'medication', rateId: 'indPc3_15Rate', suffix: '_pc_3_15' },
    'indicator-pc-3-16': { cql: 'Indicator_PC_03_16_Cross_Hospital_Prostate_Overlap',             title: '跨院前列腰藥重疊率',                    code: '基-3-16', metric: '重疊率', category: 'medication', rateId: 'indPc3_16Rate', suffix: '_pc_3_16' },
    'indicator-pc-4':    { cql: 'Indicator_PC_04_Chronic_Continuous_Prescription_Rate',           title: '慢性病連續處方簽開立率',           code: '基-4',    metric: '開立率', category: 'outpatient', rateId: 'indPc4Rate',    suffix: '_pc_4'    },
    'indicator-pc-5':    { cql: 'Indicator_PC_05_Prescription_10_Plus_Drugs_Rate',                title: '門診10種以上藥品比率',                   code: '基-5',    metric: '比率',       category: 'outpatient', rateId: 'indPc5Rate',    suffix: '_pc_5'    },
    'indicator-pc-6-1':  { cql: 'Indicator_PC_06_1_Chronic_Prescription_Days_Diabetes',           title: '糖尿病每張處方藥品日數',          code: '基-6-1',  metric: '平均日數', category: 'outpatient', rateId: 'indPc6_1Rate', suffix: '_pc_6_1' },
    'indicator-pc-6-2':  { cql: 'Indicator_PC_06_2_Chronic_Prescription_Days_Hypertension',       title: '高血壓每張處方藥品日數',          code: '基-6-2',  metric: '平均日數', category: 'outpatient', rateId: 'indPc6_2Rate', suffix: '_pc_6_2' },
    'indicator-pc-6-3':  { cql: 'Indicator_PC_06_3_Chronic_Prescription_Days_Hyperlipidemia',     title: '高血脂每張處方藥品日數',          code: '基-6-3',  metric: '平均日數', category: 'outpatient', rateId: 'indPc6_3Rate', suffix: '_pc_6_3' },
    'indicator-pc-7':    { cql: 'Indicator_PC_07_Diabetes_HbA1c_Glycated_Albumin_Rate',           title: '糖尿病HbA1c或glycated albumin執行率',  code: '基-7',    metric: '執行率', category: 'outcome',    rateId: 'indPc7Rate',    suffix: '_pc_7'    },
    'indicator-pc-8':    { cql: 'Indicator_PC_08_Same_Day_Same_Hospital_Revisit_Rate',            title: '同日同院再就診率',                          code: '基-8',    metric: '再就診率', category: 'outpatient', rateId: 'indPc8Rate', suffix: '_pc_8' },
    'indicator-pc-9-1':  { cql: 'Indicator_PC_09_1_Cesarean_Section_Rate_Overall',                title: '剖腹產率-整體',                                       code: '基-9-1',  metric: '剖腹產率', category: 'surgery', rateId: 'indPc9_1Rate', suffix: '_pc_9_1' },
    'indicator-pc-9-2':  { cql: 'Indicator_PC_09_2_Cesarean_Section_Rate_Patient_Requested',      title: '剖腹產率-自行要求',                          code: '基-9-2',  metric: '剖腹產率', category: 'surgery', rateId: 'indPc9_2Rate', suffix: '_pc_9_2' },
    'indicator-pc-9-3':  { cql: 'Indicator_PC_09_3_Cesarean_Section_Rate_With_Indication',        title: '剖腹產率-具適應症',                          code: '基-9-3',  metric: '剖腹產率', category: 'surgery', rateId: 'indPc9_3Rate', suffix: '_pc_9_3' }
};

// 分類資訊
const CATEGORIES = {
    medication: { ids: ['indicator-01','indicator-02','indicator-03-1','indicator-03-2','indicator-03-3','indicator-03-4','indicator-03-5','indicator-03-6','indicator-03-7','indicator-03-8','indicator-03-9','indicator-03-10','indicator-03-11','indicator-03-12','indicator-03-13','indicator-03-14','indicator-03-15','indicator-03-16','indicator-tcm-1','indicator-pc-1','indicator-pc-2-1','indicator-pc-2-2','indicator-pc-3-1','indicator-pc-3-2','indicator-pc-3-3','indicator-pc-3-4','indicator-pc-3-5','indicator-pc-3-6','indicator-pc-3-7','indicator-pc-3-8','indicator-pc-3-9','indicator-pc-3-10','indicator-pc-3-11','indicator-pc-3-12','indicator-pc-3-13','indicator-pc-3-14','indicator-pc-3-15','indicator-pc-3-16'], label: '用藥安全' },
    outpatient: { ids: ['indicator-04','indicator-05','indicator-06','indicator-07','indicator-08','indicator-tcm-2','indicator-tcm-3','indicator-dental-1','indicator-dental-2','indicator-dental-3','indicator-dental-4','indicator-dental-5','indicator-dental-6','indicator-pc-4','indicator-pc-5','indicator-pc-6-1','indicator-pc-6-2','indicator-pc-6-3','indicator-pc-8'], label: '門診品質' },
    inpatient:  { ids: ['indicator-09','indicator-10','indicator-11-1','indicator-11-2','indicator-11-3','indicator-11-4'], label: '住院品質' },
    surgery:    { ids: ['indicator-12','indicator-13','indicator-14','indicator-15-1','indicator-15-2','indicator-15-3','indicator-16','indicator-19','indicator-tcm-4','indicator-dental-7','indicator-dental-8','indicator-dental-9','indicator-dental-10','indicator-pc-9-1','indicator-pc-9-2','indicator-pc-9-3'], label: '手術品質' },
    outcome:    { ids: ['indicator-17','indicator-18','indicator-tcm-5','indicator-tcm-6','indicator-tcm-7','indicator-tcm-8','indicator-dental-11','indicator-dental-12','indicator-dental-13','indicator-dental-14','indicator-dental-15','indicator-dental-16','indicator-dental-17','indicator-dental-18','indicator-dental-19','indicator-dental-20','indicator-pc-7'], label: '結果品質' }
};
