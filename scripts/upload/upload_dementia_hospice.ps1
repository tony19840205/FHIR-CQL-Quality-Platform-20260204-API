# Upload Dementia Hospice Care test data
# Indicator 18: Dementia Hospice Care Utilization Rate
# 19 dementia patients total
# 8 patients using hospice care services
# Total: 51 resources (8 patients × 4 resources + 11 patients × 3 resources)

$baseUrl = "https://thas.mohw.gov.tw/v/r4/fhir"
$jsonFile = "Dementia_Hospice_19_Patients.json"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "上傳 失智症安寧緩和醫療利用率 指標測試資料" -ForegroundColor Cyan
Write-Host "指標 18: 失智症安寧緩和醫療利用率" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
