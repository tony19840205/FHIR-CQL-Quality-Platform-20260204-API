/**
 * 使用 CQL Translator 3.10.0 轉換 Indicator_15_1 到 ELM JSON
 * 指標: 353.01 - 人工膝關節置換手術後九十日以內置換物深部感染率
 */
...
const CQL_FILE = 'cql/Indicator_15_1_Knee_Arthroplasty_90Day_Deep_Infection_353_01.cql';
const OUTPUT_DIR = 'ELM_JSON';

console.log('='.repeat(80));
console.log(' CQL-to-ELM Translator 3.10.0 - Indicator 15_1 (353.01)');
console.log(' 人工膝關節置換手術後九十日以內置換物深部感染率');
console.log('='.repeat(80));
        ...
        if (res.statusCode === 200) {
            try {
                ...
                if (result.library) {
                    ...
                    const outputFile = path.join(OUTPUT_DIR, 'Indicator_15_1_Knee_Arthroplasty_90Day_Deep_Infection_353_01.json');
...
req.on('error', (e) => {
    ...
    console.log('2. 確認API服務可用: https://cql-translation-service.ahrq.gov/');
